...
final class PausableProgressBar extends FrameLayout {
    ...
    private PausableProgressBar.PausableScaleAnimation animation;
    ...
    public void setCallback(@NonNull PausableProgressBar.Callback callback) {
    ...
    void setMinWithoutCallback() {
        maxProgressView.setBackgroundResource(R.color.red);
    ...
    private void finishProgress(boolean isMax) {
        if (isMax) maxProgressView.setBackgroundResource(R.color.red);
    ...
    public void startProgress() {
        ...
        animation = new PausableProgressBar.PausableScaleAnimation(0, 1, 1, 1, Animation.ABSOLUTE, 0, Animation.RELATIVE_TO_SELF, 0);
