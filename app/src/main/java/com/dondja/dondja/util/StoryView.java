...
public class StoryView extends LinearLayout {
    ...
    private static final String TAG = jp.shts.android.storiesprogressview.StoriesProgressView.class.getSimpleName();
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        ...
        storiesCount = typedArray.getInt(R.styleable.StoryView_progressCount, 0);
        typedArray.recycle();
        bindViews();
    }
